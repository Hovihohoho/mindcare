...
const styles = StyleSheet.create({
  content: { gap: spacing.sm, padding: spacing.md, paddingBottom: 64 },
  ...
  option: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.line, borderRadius: radius.card, borderWidth: 1, flexDirection: 'row', gap: spacing.sm, minHeight: 60, padding: spacing.md, ...shadows.card },
  optionSelected: { backgroundColor: colors.surfaceMuted, borderColor: colors.brand },
  ...
  resultContent: { gap: spacing.sm, padding: spacing.md, paddingBottom: 64 },
  resultCard: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.line, borderRadius: radius.card, borderWidth: 1, padding: spacing.lg, ...shadows.card },
  ...
  recommendation: { alignItems: 'flex-start', backgroundColor: colors.surface, borderColor: colors.line, borderRadius: radius.input, borderWidth: 1, flexDirection: 'row', gap: spacing.sm, padding: spacing.md },
