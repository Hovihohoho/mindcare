...
public class StressFeatureController {
    private final StressFeatureService service;

    public StressFeatureController(StressFeatureService service) {
        this.service = service;
    }

    @GetMapping("/stress-features")
    public StressFeatureResponse features(
