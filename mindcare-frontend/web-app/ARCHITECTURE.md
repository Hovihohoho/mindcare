...
authentication, assessments, emotion journals, AI chat, bookmarks, profile,
settings, and notifications. Administrative capabilities include user management,
assessment content, AI knowledge documents, notifications, and audit logs.
