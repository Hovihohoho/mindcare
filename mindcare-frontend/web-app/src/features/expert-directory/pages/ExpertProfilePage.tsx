        ...
        <div className="space-y-6">
          ...
          <Card className="p-7">
            ...
            <dl className="mt-6 grid gap-5 sm:grid-cols-2">
              ...
              {item.education && <div className="sm:col-span-2"><dt className="text-sm text-muted">Học vấn và bằng cấp</dt><dd className="mt-1 font-semibold">{item.education}</dd></div>}
              {item.bio && <div className="sm:col-span-2"><dt className="text-sm text-muted">Giới thiệu</dt><dd className="mt-1">{item.bio}</dd></div>}
            </dl>
          </Card>
          <Card className="p-7">
