...
export const homeServices = [
  ...
  { icon: UsersRound, title: "Trao đổi với chuyên gia", description: "Chủ động trò chuyện với chuyên gia đã được hệ thống phê duyệt, không cần đặt lịch hoặc thanh toán.", to: "/experts", tone: "bg-orange-200" },
] as const;
